    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("pattern") !== undefined) {
                            message = "فرمت وارد شده صحیح نیست<!-- data-validation-pattern-message to override -->";
                        ...
                        if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
                            ...
                            message = "حداکثر'" + max + "'<!-- data-validation-max-message to override -->";
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "حداقل '" + min + "'<!-- data-validation-min-message to override -->";
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "حداکثر'" + $this.attr("maxlength") + "' کارکتر<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "حداقل'" + $this.attr("minlength") + "' کارکتر<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "آدرس ایمیل وارد شده معتبر نیست<!-- data-validation-email-message to override -->";
        ...
        validatorTypes: {
            ...
            regex: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "اطلاعات با فرمت صحیح وارد نمایید";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
            ...
            email: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "آدرس ایمیل معتبر وارد نمایید";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
            ...
            required: {
                name: "required",
                init: function ($this, name) {
                    var message = "تکمیل این بخش الزامی است.";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "اطلاعات وارد شده باید یکسان باشد";
                    var $label = null;
            ...
            max: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "حداکثر '" + result.max + "'";
                    if ($this.data("validation" + name + "Message")) {
            ...
            min: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "حداقل '" + result.min + "'";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
            ...
            maxlength: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "حداکثر '" + result.maxlength + "' کارکتر";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
            ...
            minlength: {
                ...
                init: function ($this, name) {
                    ...
                    result.message = "حداقل '" + result.minlength + "' کارکتر";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
            ...
            maxchecked: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "حداکثر '" + result.maxchecked + "' انتخاب شود";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
            ...
            minchecked: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "حداقل '" + result.minchecked + "' انتخاب شود";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
        ...
        builtInValidators: {
            ...
            passwordagain: {
                ...
                type: "match",
                match: "password",
                message: "کلمه های عبور یکسان وارد نشده است<!-- data-validator-paswordagain-message to override -->"
            },
            positive: {
                name: "Positive",
                type: "shortcut",
                shortcut: "عدد,عدد مثبت"
            },
            negative: {
                name: "Negative",
                type: "shortcut",
                shortcut: "عدد,عدد منفی"
            },
            integer: {
                name: "Integer",
                type: "regex",
                regex: "[+-]?\\d+",
                message: "فقط عدد صحیح<!-- data-validator-integer-message to override -->"
            },
            positivenumber: {
                name: "Positivenumber",
                type: "min",
                min: 0,
                message: "فقط عدد مثبت<!-- data-validator-positivenumber-message to override -->"
            },
            negativenumber: {
                name: "Negativenumber",
                type: "max",
                max: 0,
                message: "فقط عدد منفی<!-- data-validator-negativenumber-message to override -->"
            },
            required: {
                name: "Required",
                type: "required",
                message: "تکمیل این بخش الزامی است<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
                minchecked: 1,
                message: "حداقل یک مورد را انتخاب نمایید<!-- data-validation-checkone-message to override -->"
            },
            number: {
                name: "Number",
                type: "number",
